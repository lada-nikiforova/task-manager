...
export const TaskItem: React.FC<Props> = ({ task }) => {
  ...
  return (
    <div className={`w-52 lg:w-65 cursor-pointer text-black shadow-xl rounded-2xl p-3 border-3 border-indigo-300  hover:shadow-indigo-300`}>
      <div className={`${bgCategory} inline-flex items-center rounded-full mb-2`}>
        <p className="text-md lg:text-xl px-3 py-1 font-medium">{task.category}</p>
      </div>
